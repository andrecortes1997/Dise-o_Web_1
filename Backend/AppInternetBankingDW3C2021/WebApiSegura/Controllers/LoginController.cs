    ...
    public class LoginController : ApiController
    {
        ...
        public IHttpActionResult Authenticate(LoginRequest loginRequest)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"SELECT Codigo, Identificacion
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        //usuario.Username = sqlDataReader.GetString(2);
                        //usuario.Password = sqlDataReader.GetString(3);
                        ...
                        var token = TokenGenerator.GenerateTokenJwt(usuario.Identificacion);
                        usuario.Token = token;
                    }
